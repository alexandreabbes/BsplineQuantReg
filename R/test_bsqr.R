...
if (verbose){message("3rd order constraints list:",der3cons)}
    res_3rd <- quantile_spline(xtab=xtab, ytab=ytab, knot=knot,degree=degree,monot=0,convcons=0,der3cons=der3cons, tau = 0.5, verbose=verbose)
  ...
  plot(xtab, ytab, pch = 16, cex = 0.5, col = "black",
       main = "Mixed mootone : increasing constraints \n on the first inter-knot)")
...
#der3>0
  plot(xtab, ytab, pch = 16, cex = 0.5, col = "black",
      main = "3rd deriv on the second half")
